...
using DAL;
using Core3_Angular8.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using Core3_Angular8.Helpers;

namespace Core3_Angular8.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from Core3_Angular8", message);
